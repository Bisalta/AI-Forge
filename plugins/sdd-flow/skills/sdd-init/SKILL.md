...
8bis. **Si `SDD/escalations.md` no existe, creálo desde `templates/escalations-ledger.md`** (tabla vacía — el backfill de otro repo no aplica acá). Si ya existe, no lo toques: es un ledger append-only con historia propia.

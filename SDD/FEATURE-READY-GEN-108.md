...
| **v26** | Postgres autentica al servidor con el bundle de RDS (`AC58`). Las seis conexiones conectan con `verify-full`, y con una autoridad ajena falla. El secret-scan no escanea el base64 de los certificados públicos, por contenido y no por path (`AC59`). **En review** (§7.5) |
...
| **Deuda, retro y escalaciones del ciclo** | 47 ítems de deuda (32 abiertos), 34 entradas de retro hasta `RT56` y 12 escalaciones hasta `E20` |

...
**Branch**: `feat-GEN-108-mcp-bisalta-db` → `prod` · **Contract**: `SDD/contracts/2026-09-18-bisalta-db-mcp.md` **v24** · **Proxima**: `GEN-108` (`GEN-108.1`, `GEN-108.2`)
...
3. **`SDD/verification/feat-GEN-108-mcp-bisalta-db-v24.md`** — la escalera sellada sobre el árbol actual y las cuatro mutaciones corridas sobre él. **`…-v23-D67.md`** trae los controles de aislamiento de la (a), y **`…-v23.md`**, los 48 casos agrupados y el binding. El de v22 trae la verificación en vivo con el plugin instalado.
...
| **v24** | Cinco casos del planner para la mutación (c), que ahora cae (`D64`). Las cuatro mutaciones de `AC51` caen sobre el árbol actual. **En review** (§7.5) |
...
| **Deuda, retro y escalaciones del ciclo** | 38 ítems de deuda (24 abiertos), 32 entradas de retro hasta `RT54` y 12 escalaciones hasta `E20` |
...
5. **Review §7.5 de v24** — en curso.
6. **Merge.** Requiere la review de un code owner (`@Bisalta/construplaza-admin`). No habilita nada al equipo por sí solo.

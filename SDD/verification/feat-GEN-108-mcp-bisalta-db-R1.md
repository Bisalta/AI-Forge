...
- **Branch**: `feat-GEN-108-mcp-bisalta-db` · **Commit**: `fd9447e` · **Doc**: `SDD/docs/doc_quality_gates.md` (`sha256:a8f010a76c4f561a`) · **Fecha**: 2026-09-18T18:27:35Z
- Tree: `651a1c0dafb5087d128a0d4a599f0f4dbe4aed68` — LIMPIO
...
|---|---|---|---|---|---|
| 1 | format / style | — | — | 2026-09-18T18:26:44Z | [SKIPPED] sin comando en el doc (N/A — shfmt no está instalado) |
| 2 | lint | `shellcheck --severity=warning plugins/sdd-flow/scripts/*.sh plugins/sdd-flow/hooks/*.sh plugins/usage-monitor/scripts/*.sh SDD/tests/*.sh SDD/scripts/*.sh` | 0 | 2026-09-18T18:26:44Z | verde |
| 3 | type-check | — | — | 2026-09-18T18:26:45Z | [SKIPPED] sin comando en el doc (N/A — bash no es tipado) |
| 4 | unit tests | `bash SDD/tests/run.sh` | 0 | 2026-09-18T18:26:45Z | verde |
| 5 | integration | — | — | 2026-09-18T18:27:09Z | [SKIPPED] sin comando en el doc (N/A — los tests del harness ya ejercitan los scripts end-to-end) |
| 6 | build | — | — | 2026-09-18T18:27:09Z | [SKIPPED] sin comando en el doc (N/A — el plugin no compila) |
| 7 | e2e | — | — | 2026-09-18T18:27:09Z | [SKIPPED] sin comando en el doc (N/A) |
| 8 | cobertura del diff | — | — | 2026-09-18T18:27:09Z | [SKIPPED] sin comando en el doc (N/A — sin reporte de coverage; se verifica con el binding AC↔test) |
| 9 | security | `bash SDD/tests/secret-scan.sh` | 0 | 2026-09-18T18:27:09Z | verde |
| 10 | smoke manual | — | — | 2026-09-18T18:27:10Z | [SKIPPED] sin comando en el doc (N/A) |
| — | suite completa | `bash SDD/tests/run.sh` | 0 | 2026-09-18T18:27:10Z | verde |
...
5. **Commit `fd9447e`** (el commit del literal partido, entrada 4): corrida final de ronda 2, verde en los cuatro gates aplicables (2, 4, 9, suite completa) — es la que escribió el bloque superior de este archivo, árbol limpio (ver hash de árbol en el encabezado hasta arriba).

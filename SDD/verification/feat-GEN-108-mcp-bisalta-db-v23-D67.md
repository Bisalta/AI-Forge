...
- **(a) cae.** Hacen falta dos lecturas:
  ...
  - Los casos 12 a 16, que son de construcción sin cerrar, en sus dos asserts, caen además por el adaptador: la función vieja no detecta construcciones sin cerrar, así que el adaptador siempre devuelve `sinCerrar: null`.

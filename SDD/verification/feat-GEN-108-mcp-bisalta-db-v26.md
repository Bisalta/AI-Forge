...
- **Branch**: `feat-GEN-108-mcp-bisalta-db` · **Commit**: `c333b6f` · **Doc**: `SDD/docs/doc_quality_gates.md` (`sha256:56736c3e5b778ea1`) · **Fecha**: 2026-09-25T19:02:22Z
- Tree: `adc081de602d556eb7bda5c3d44a367f326191e6` — LIMPIO
...
|---|---|---|---|---|---|
| 1 | format / style | — | — | 2026-09-25T18:59:51Z | [SKIPPED] sin comando en el doc (N/A — shfmt no está instalado) |
| 2 | lint | `shellcheck --severity=warning plugins/sdd-flow/scripts/*.sh plugins/sdd-flow/hooks/*.sh plugins/usage-monitor/scripts/*.sh SDD/tests/*.sh SDD/scripts/*.sh` | 0 | 2026-09-25T18:59:51Z | verde |
| 3 | type-check | — | — | 2026-09-25T18:59:53Z | [SKIPPED] sin comando en el doc (N/A — bash no es tipado) |
| 4 | unit tests | `bash SDD/tests/run.sh` | 0 | 2026-09-25T18:59:53Z | verde |
| 5 | integration | — | — | 2026-09-25T19:01:07Z | [SKIPPED] sin comando en el doc (N/A — los tests del harness ya ejercitan los scripts end-to-end) |
| 6 | build | — | — | 2026-09-25T19:01:07Z | [SKIPPED] sin comando en el doc (N/A — el plugin no compila) |
| 7 | e2e | — | — | 2026-09-25T19:01:07Z | [SKIPPED] sin comando en el doc (N/A) |
| 8 | cobertura del diff | — | — | 2026-09-25T19:01:07Z | [SKIPPED] sin comando en el doc (N/A — sin reporte de coverage; se verifica con el binding AC↔test) |
| 9 | security | `bash SDD/tests/secret-scan.sh` | 0 | 2026-09-25T19:01:07Z | verde |
| 10 | smoke manual | — | — | 2026-09-25T19:01:09Z | [SKIPPED] sin comando en el doc (N/A) |
| — | suite completa | `bash SDD/tests/run.sh` | 0 | 2026-09-25T19:01:09Z | verde |
...
Es el script de v25 con estos cambios. `AC55 (a)` quita ahora la línea de `verify-full`. Hay tres mutaciones nuevas de `AC58` y siete de `AC59`, de la (a) a la (g), que corren contra `SDD/tests/test_secret_scan.sh`. Y el script exige árbol limpio también al empezar (`RT56`).
...
- Las 44 caen, y las 88 corridas verdes, la del árbol real y la restaurada de cada una, salen `exit=0 fail=0`.
...
```
árbol 15e0fe6 · bundle sha256 e5bb2084ccf45087
...
| `AC59` | `SDD/tests/test_secret_scan.sh`: formas 7 a 13 (`forma7 …`, `forma8 …` —dos—, `forma9 …` —dos—, `forma10 …` —tres—, `forma11 …` —dos—, `forma12 …` y `forma13 …`), y el control final de árbol limpio |
